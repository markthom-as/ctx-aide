...
- Verification evidence:
  - `node tools/ctx-aide/ctx-aide.mjs components list --json`
  - `node tools/ctx-aide/ctx-aide.mjs components get component.ContextEntryCard --json`
  - `node tools/ctx-aide/ctx-aide.mjs query --path docs/context/components/context-entry-card.md --task "component catalog design token" --agent codex --budget 1200 --json`
  - `make validate`
