...
- `ticket.context.001`: draft - Add repo-local context markdown substrate
- `ticket.context.002`: draft - Implement ctx scan query lint CLI foundation
- `ticket.context.003`: draft - Generate Codex Claude and Cursor context packs
...
- `ticket.context.007`: draft - Add canonical ticket statuses and ticket packs
...
- `ticket.context.010`: draft - Add Semble-backed code discovery
- `ticket.context.011`: draft - Add daily usability tooling
